...
TEST(NameSearchTest, NoOptionTest) {
	g_DB.clear();
	g_DB.emplace_back(EmployeeInfo({ "18051224", "조 영철", "CL2" , "010-4198-8858", "19930116", "PRO" }));
	g_DB.emplace_back(EmployeeInfo({ "17256132", "신 준혁", "CL2" , "010-2135-1546", "19910526", "EX" }));
	g_DB.emplace_back(EmployeeInfo({ "20031242", "공 정훈", "CL2" , "010-4756-9871", "19930821", "PRO" }));
	g_DB.emplace_back(EmployeeInfo({ "14321152", "김 인수", "CL2" , "010-1312-4356", "19910415", "ADV" }));
	g_DB.emplace_back(EmployeeInfo({ "12035123", "김 종원", "CL3" , "010-6855-9852", "19850720", "PRO" }));
	g_DB.emplace_back(EmployeeInfo({ "08051231", "오 신호", "CL4" , "010-5563-8744", "19800420", "PRO" }));
